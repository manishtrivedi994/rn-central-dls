...
var _base = _interopRequireDefault(require("../theme/color/base"));
...
const Close = ({
  ...
  fillOpacity = 0.69,
  ...props
}) => /*#__PURE__*/React.createElement(_reactNativeSvg.default, _extends({
  width: 16,
  height: 16,
  fill: "none"
...
}), /*#__PURE__*/React.createElement(_reactNativeSvg.Defs, null, /*#__PURE__*/React.createElement(_reactNativeSvg.LinearGradient, {
  id: "a",
  x1: 6.968,
  x2: 14.468,
  y1: 1.771,
...
const AshokaChakra = ({
  ...
  height: 24,
  fill: "none"
}, props), /*#__PURE__*/React.createElement(_reactNativeSvg.Circle, {
  cx: 9,
  cy: 5.996,
  r: 1.012,
  fill: color
...
const ChevronDown = ({
  color = _rnCentralDls.color.BASE.icon.defaultPrimary,
  ...props
}) => /*#__PURE__*/React.createElement(_reactNativeSvg.default, _extends({
  width: 16,
  height: 16,
...
const ChevronRightDoubleOutlined = ({
  ...
  width: _size.default.IconSize.iconSize32,
  height: _size.default.IconSize.iconSize32,
  viewBox: "0 0 32 32",
  fill: "none"
}, props), /*#__PURE__*/React.createElement(_reactNativeSvg.Path, {
  fill: color,
...
const CheckOutlined = ({
  ...
  width: _size.default.IconSize.iconSize24,
  height: _size.default.IconSize.iconSize24,
  viewBox: "0 0 24 24",
  fill: "none"
}, props), /*#__PURE__*/React.createElement(_reactNativeSvg.Path, {
  stroke: color,
...
const StarOutlined = ({
  ...
  fill: color
}), halfFilled && /*#__PURE__*/React.createElement(_reactNativeSvg.Path, {
...
const DashedLine = ({
  ...
  x2: width,
  y2: "1",
  stroke: _base.default.border.defaultPrimary,
  strokeWidth: "2",
  strokeDasharray: "4,4"
}));
const Check = ({
...
var _default = exports.default = Svgs;
