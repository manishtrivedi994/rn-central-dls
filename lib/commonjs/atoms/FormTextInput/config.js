...
var _VehiclePrefix = require("../StandaloneTextInput/components/VehiclePrefix");
...
const TEXT_PROP_MAP = ({
  ...
  [_type.TextInputType.VEHICLE_NO]: {
    ...
    prefix: /*#__PURE__*/_react.default.createElement(_index.default.AshokaChakra, {
...
const TEXT_PROP_MAP_STANDALONE = colors => ({
  [_type2.StandaloneTextInputType.VEHICLE_NO]: {
    formatter: regNoFormatter,
    unformatter: regNoUnFormatter,
    prefix: /*#__PURE__*/_react.default.createElement(_VehiclePrefix.VehiclePrefix, {
      colors: colors
    }),
    placeholder: 'DL 12 AA 1234',
    maxLength: 15,
