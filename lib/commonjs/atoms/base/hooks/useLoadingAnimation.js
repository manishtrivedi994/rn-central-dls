...
exports.useLoadingAnimation = void 0;
...
const useLoadingAnimation = props => {
  ...
  const loadingAnimation = (0, _react.useRef)(new _reactNative.Animated.Value(0)).current;
  const lastRunningAnimation = (0, _react.useRef)();
  (0, _react.useEffect)(() => {
    if (isLoading) {
      ...
      lastRunningAnimation.current = _reactNative.Animated.loop(_reactNative.Animated.timing(loadingAnimation, {
